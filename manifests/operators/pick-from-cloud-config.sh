...
# The base manifests/sample-webapp-using-redis.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/sample-webapp-using-redis.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
